...
{if $status == 'ok'}
<p>{l s='Your order on %s is complete.' sprintf=$shop_name mod='paymentendofthemonth'}
		<br /><br />
		...
		{if !isset($reference)}
			<br /><br />- {l s='Do not forget to insert your order number #%d in the subject of your bank wire.' sprintf=$id_order mod='paymentendofthemonth'}
		{else}
			<br /><br />- {l s='Do not forget to insert your order reference %s in the subject of your bank wire.' sprintf=$reference mod='paymentendofthemonth'}
		{/if}		<br /><br />{l s='An email has been sent with this information.' mod='paymentendofthemonth'}
